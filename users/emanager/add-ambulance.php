...
<?php header_section("EMS | Add Ambulance"); ?>

<main class="container py-2 my-3 border">
    <div class="row">
        <div class="col-12">
            <h1 class="text-center">Add Ambulance</h1>
        </div>
    </div>
    ...
    <div class="row d-flex justify-content-center align-items-center">
        <div class="row">
            ...
            <div class="col-md-<?php echo _get_is_logged_in() ? "9" : "12"; ?>">
                ...
                <form id="add-ambulance-form" action="<?php echo _get_url("controllers/AddAmbulanceController.php"); ?>" method="POST" class="need-validation">
                    <div class="row">

                        <div class="row mb-3 has-validation">
                            <label for="phone" class="col-sm-3 col-form-label">Phone</label>
                            <div class="col-sm-9">
                                <input id="phone" type="text" name="phone" class="form-control<?php echo _get_messages_css_class_name('phone'); ?>" value="<?php echo _get_messages_data('phone'); ?>" placeholder="+88016xxxxxxxx" onkeyup="validate_ambulance_phone(this);">
                        ...
                        <div class="row mb-3 has-validation">
                            ...
                            <div class="col-sm-3 mb-3 text-sm-start">
                                <button id="add-ambulance-btn" type="submit" name="add-ambulance" class="btn btn-success">Add Ambulance</button>
                            </div>
                        </div>
                    </div>
                </form>
