...
if (isset($_POST['edit-profile'])) {
    ...
    // _print_r([$name, $email, $gender, $dob, _get_session_val('utype'), _get_session_val('email'), _get_session_val('id')]);
    // _var_dump($has_err);
    // _var_dump($messages);
    // return;
    ...
    if (!$has_err) {
        ...
        switch (_get_session_val('utype')) {
            case "admin":
                ...
                if (!$is_dublication) {
                    ...
                    $admin->setAId(_get_session_val('id'));
                    $admin->setUName($name);
                    ...
                    _set_session_val('name', $name);
                    _set_session_val('email', $email);
                    _set_session_val('phone', $phone);
                    _set_session_val('gender', $gender);
                    _set_session_val('dob', $dob);
            ...
            case "doctor":
                ...
                if (!$is_dublication) {
                    ...
                    $doctor->setDId(_get_session_val('id'));
                    ...
                    _set_session_val('degree', $degree);
                    _set_session_val('specialization', $specialization);
                    _set_session_val('schedule', $schedule);

                    _set_session_val('area', $area);
                    _set_session_val('subdistrict', $subdistrict);
                    _set_session_val('district', $district);
                    _set_session_val('division', $division);
            ...
            case "emanager":
                ...
                if (!$is_dublication) {
                    ...
                    $emanager->setEmId(_get_session_val('id'));
                    ...
                    _set_session_val('work_subdistrict', $work_subdistrict);
            ...
            case "patient":
                ...
                if (!$is_dublication) {
                    ...
                    $patient->setPId(_get_session_val('id'));
        ...
        if (!$is_dublication) {
            ...
            if ($is_update) {
                ...
                header("Location: " . _get_url("dashboard/edit-profile.php"));
            } else {
                // Send successful message
